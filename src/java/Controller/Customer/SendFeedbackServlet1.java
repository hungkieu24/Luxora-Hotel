 ...
 * @author KTC
 */
@WebServlet(name="SendFeedbackServlet1", urlPatterns={"/sendFeedback1"})
public class SendFeedbackServlet1 extends HttpServlet {
    ...
    throws ServletException, IOException {
        ...
        request.getRequestDispatcher("sendFeedback1.jsp").forward(request, response);
    }
