                ...
                <div class="row justify-content-between">
                    ...
                    <div class="col-xl-7 col-lg-7 order-lg-1">
                        ...
                        <div class="main-content">
                            <form id="editProfile" action="editProfile1" method="post" enctype="multipart/form-data">
                                ...
                                <button type="button" class="cancel-btn" onclick="window.location.href = 'editProfile1';">Cancel</button>
